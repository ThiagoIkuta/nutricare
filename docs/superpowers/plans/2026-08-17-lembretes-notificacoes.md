...
- **Spec coverage:** every bullet in the spec's decisions (1–8) and every table/endpoint/page in the design sections is implemented by a task above — recurrence engine (Tasks 1–2), tables (Task 3), reminders CRUD (Tasks 4–6), notifications/inbox/preferences (Tasks 7–9), system-event wiring for all three required triggers (Tasks 10–11), frontend hook/pages/nav wiring (Tasks 13–17), and manual verification of both layers (Tasks 12, 18).
